const ingresos = [
  new Ingreso('Salario',20000), //3200
  new Ingreso('Venta Auto', 50000), //400
  new Ingreso('Freelance', 6000) //20
];

const egresos = [
  new Egreso ('Renta',4000),//900
  new Egreso ('Ropa', 800), //400
  new Egreso ('Comida', 2000) //100
];
